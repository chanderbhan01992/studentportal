...
csv_filepathname="/home/portal/studentportal/studentportal/LoadCSVs/Student_Portal-company_table.csv"
...
for row in dataReader:
	...
	c.intern_exp_count = row[5]
	c.job_exp_count = row[6]
	c.company_intern_valid = row[7]
	c.company_job_valid = row[8]
	c.startdate = row[9]
	#c.recentdate = row[10]
	c.valid = row[11]
	'''
