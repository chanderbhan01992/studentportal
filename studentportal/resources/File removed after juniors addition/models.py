...
class company_table(models.Model):
     ...
     recentdate = models.DateField(default=datetime.date.today(),null=False)  #Gives the recent date of visit to the campus
...
class experience_placement(models.Model):
     ...
     round1_text=models.ForeignKey(InterviewRound_details,null=True,related_name="%(class)s_round1")
     round2_text=models.ForeignKey(InterviewRound_details,null=True,related_name="%(class)s_round2")
     round3_text=models.ForeignKey(InterviewRound_details,null=True,related_name="%(class)s_round3")
     round4_text=models.ForeignKey(InterviewRound_details,null=True,related_name="%(class)s_round4")
     round5_text=models.ForeignKey(InterviewRound_details,null=True,related_name="%(class)s_round5")
     round6_text=models.ForeignKey(InterviewRound_details,null=True,related_name="%(class)s_round6")
